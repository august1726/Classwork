...
public class TreasureHunt extends PApplet {
  ...
  public void initGame() {
    ...
    gameObjects.add(new RestartGameButton(0, 0));
    gameObjects.add(new ScreenshotButton(140, 0));
  }
   ...
   * @return - returns a reference to an interactive object with the specified name, or null when
   *         none is found
   */
