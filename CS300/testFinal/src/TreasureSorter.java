...
public class TreasureSorter {    
  ...
  private static int removeTreasure(Double[] heap, int size) {
    ...
    return size - 1; // default return statement added to avoid compiler errors. Feel free to change it.
  }    
