...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
		...
		if (child.parent.data.equals(parent.data)) {
			if ((parent.leftChild.data != null && parent.leftChild.data.equals(child.data)) 
					|| (parent.rightChild.data != null && parent.rightChild.data.equals(child.data))) {
	...
	/**
	 * tests rotating a node and its left child
	 * 
	...
	public static boolean test1() {
		try {
			...
			tree.insert(7);
			tree.insert(6);
			String temp = tree.toLevelOrderString();
			if (!temp.equals("[ 10, 9, 7, 6 ]")) {
				return false;
			}
			tree.rotate(tree.root.leftChild.leftChild, tree.root.leftChild);
			temp = tree.toLevelOrderString();
			if (!temp.equals("[ 10, 7, 6, 9 ]")) {
				return false;
			}
			return true;
		} catch (Exception e) {
    ...
    /**
	 * tests rotating a the root node and its right child and makes sure its
	...
	public static boolean test2() {
		try {
			...
			tree.insert(7);
			String temp = tree.toLevelOrderString();
			if (!temp.equals("[ 4, 2, 6, 1, 3, 5, 7 ]")) {
				return false;
			}
			tree.rotate(tree.root.rightChild, tree.root);
			temp = tree.toLevelOrderString();
			if (!temp.equals("[ 6, 4, 7, 2, 5, 1, 3 ]")) {
				return false;
			}
			return true;
		} catch (Exception e) {
    ...
    /**
     * Tests if rotate() throws exceptions correctly
     * 
     * @return true if tests pass, false if tests fail
     */
    public static boolean test3() {
    	...
    	tree.insert(52);
    	tree.insert(99);
    	tree.rotate(tree.root.rightChild, tree.root.rightChild.rightChild);
    	return false;
